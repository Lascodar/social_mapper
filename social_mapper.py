...
def authenticate():
    try:
        ...
        sys.exit("[!] Could not authenticate to LinkedIn. {}".format(str(e)))
    return cookies
...
for person in peoplelist:
    body = "<tbody>" \
           ...
           "</tr>" \
           "</tbody>" % (
               person.person_imagelink, person.person_imagelink, person.full_name, person.linkedin,
